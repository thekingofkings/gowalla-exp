...
plot(dist1, exp( -0.1 * dist1 ), '--', 'color', [174, 34, 34]/255);
plot(dist1, exp( - dist1 ), '-', 'color', [0, 0, 0.5]);
plot(dist1, exp( - 2 * dist1 ), '-', 'color', [0.3, 0.4, 1] );
plot(dist1, exp( - 3 * dist1 ), '-', 'color', [0.5, 0.8, 1] );
...
legend({'0.01', '0.1', '1', '2', '3', '5', '10'}, 'fontsize', 16, ...
    'location', 'northeast');
set(gca, 'xscale', 'log', 'linewidth', 1, 'fontsize', 18, ...
